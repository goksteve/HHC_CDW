...
INSERT INTO cnf_dw_refresh VALUES(10, 'MERGE', 'REF_ORDER_TYPES', NULL, 'SELECT DISTINCT order_type_id, name FROM order_type', NULL, NULL, 'Y', NULL);
INSERT INTO cnf_dw_refresh VALUES(20, 'MERGE', 'REF_PROC_EVENT_ARCHIVE_TYPES', NULL, 'SELECT DISTINCT archive_type_id, name FROM proc_event_archive_type', NULL, 'WHERE archive_type_id <> 0', 'Y', NULL);
INSERT INTO cnf_dw_refresh VALUES(50, 'MERGE', 'DIM_PAYERS', NULL, 'PT008.PAYER_MAPPING', 'NETWORK,PAYER_ID', NULL, 'Y', NULL);
